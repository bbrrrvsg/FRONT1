...
for (let i = 0; i < numbers1.length; i++) {
    let index_123 = numbers1.indexOf()
    if (nlist.indexOf(numbers1[i]) == -1) {
        nlist.push(numbers1[i])
    }
}
console.log(nlist)
...
let numbers2 = [5, 3, 4, 1, 2];

for (let i = 0; i < numbers2.length; i++) {
    for (let j = numbers2.length - 1; j >= i + 1; j--) {
        let temp
...
// let products_user = prompt('상품명');
// let stock_user = parseInt(prompt('수량'));

// if (products.indexOf(products_user) != -1) {
//     let index_tt = products.indexOf(products_user)
//     if (stock_user > stock[index_tt]) {
//         console.log('재고가 부족')
//     }
//     else {
//         console.log('구매완료')
//         stock[index_tt] -= stock_user
//     }
// } else { console.log('없는 제품') }
// console.log('남은 재고 수량 : ' + stock)
...
//     let star123 = '';
//     let star1;
//     star1 = movieRatings[j];
//     for (let i = 1; i <= star1; i++) {
//         star123 += '★'
//     }
//     for (let i = 1; i <= 10 - star1; i++) {
//         star123 += '☆'
//     }
//     console.log(`${movieNames[j]}${star123}`)
//     document.querySelector('h3').innerHTML += `${movieNames[j]}${star123}<br>`
// }
