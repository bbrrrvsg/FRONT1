...
// 키를 알면 값을 알수 있지만 값은 키를 알수 없다

const inventory = { apple: 15, banana: 5, orange: 20, grape: 8 };
let keys1 = Object.keys(inventory);
for (let i = 0; i < keys1.length; i++) {
  if (inventory[keys1[i]] < 10) {
    console.log(keys1[i])
  }
}
